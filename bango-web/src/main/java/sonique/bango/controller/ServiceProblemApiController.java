...
public class ServiceProblemApiController {
    ...
    public ResponseData<List<EventHistoryItem>> eventHistory(@PathVariable Long serviceProblemId, @ModelAttribute SearchParametersDTO searchParameters) {
        return new ResponseData<>(serviceProblemApiService.eventHistory(new ServiceProblemId(serviceProblemId), searchParameters).getData());
    }
